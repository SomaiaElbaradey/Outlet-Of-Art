...
export class ProfileService {
  ...
  public updateImage(_image): Observable<any> {
    console.log(_image);
    return this._HttpClient.patch(`${this.baseURL}/image`, _image, {
      headers: new HttpHeaders().set('x-token', localStorage.getItem('Token')),
      observe: 'response',
    });
  }
  public updateInfo(_user): Observable<any> {
    return this._HttpClient.patch(`${this.baseURL}/update`, _user, {
      headers: new HttpHeaders().set('x-token', localStorage.getItem('Token')),
      observe: 'response',
    });
  }
  ...
  public getOrders(): Observable<any> {
    return this._HttpClient.get(`${this.orderURL}`, {
      headers: new HttpHeaders().set('x-token', localStorage.getItem('Token')),
      observe: 'response',
    });
  }
  ...
  public deleteUser(): Observable<any> {
    return this._HttpClient.delete(`${this.baseURL}/delete`, {
      headers: new HttpHeaders().set('x-token', localStorage.getItem('Token')),
      observe: 'response',
    });
  }
